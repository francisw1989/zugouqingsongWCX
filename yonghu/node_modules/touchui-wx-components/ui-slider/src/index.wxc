  ...
  <view class="ui-slider"  style="position: relative;{{sliderStyle}}">
    ...
    <view class="slider-bar-wrap1"
      ...
      style="{{sliderBarWrapStyle}};{{sliderBarWrapDynamicStyle}};{{sliderBarAnimateStyle}}">
        ...
        wx:if="{{showTooltip}}"
        >{{mark}}{{unlimited ? (showDoubleBarWrap ? value[0] : value) > max - step ? '不限' : (showDoubleBarWrap ? value[0] : value) : (showDoubleBarWrap ? value[0] : value)}}{{danwei}}</view>
        <view class="slider"
    ...
    <view 
      ...
      style="{{sliderBarWrapStyle}};{{sliderBarWrap2DynamicStyle}};{{sliderBarAnimateStyle}}">
       ...
       style="{{tooltipStyle}};{{tooltipCustomStyle}};"
       wx:if="{{showTooltip}}"
       >{{mark}}{{unlimited ? (showDoubleBarWrap ? value[1] : value) > max - step ? '不限' : (showDoubleBarWrap ? value[1] : value) : (showDoubleBarWrap ? value[1] : value)}}{{danwei}}</view> 
       <view class="slider"
